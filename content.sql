...
-- Exportiere Daten aus Tabelle restaurant.customers: ~100 rows (ungefähr)
INSERT INTO `customers` (`CustomerID`, `FirstName`, `LastName`, `Email`, `Address`, `City`, `State`, `Phone`, `Birthday`, `FavoriteDish`) VALUES
...
-- Exportiere Daten aus Tabelle restaurant.customersdishes: ~8 rows (ungefähr)
INSERT INTO `customersdishes` (`CustomersDishesID`, `CustomerID`, `DishID`) VALUES
	(1, 7, 3),
	(2, 7, 4),
	(3, 7, 21),
	(4, 41, 3),
...
-- Exportiere Daten aus Tabelle restaurant.customersevents: ~10 rows (ungefähr)
INSERT INTO `customersevents` (`CustomersEventsID`, `CustomerID`, `EventID`) VALUES
	(1, 7, 1),
	(2, 7, 2),
	(3, 42, 1),
	(4, 89, 1),
...
-- Exportiere Daten aus Tabelle restaurant.dishes: ~22 rows (ungefähr)
INSERT INTO `dishes` (`DishID`, `Name`, `Description`, `Price`) VALUES
	(1, 'Parmesan Deviled Eggs ', 'These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.  ', 8.00),
...
-- Exportiere Daten aus Tabelle restaurant.events: ~15 rows (ungefähr)
INSERT INTO `events` (`EventID`, `Name`, `Description`, `Date`, `Location`) VALUES
	(1, 'Winter Wonderland', 'Join us to celebrate 2014 in a garden of organic splendor! This event will focus on seasonal treats made with health in mind!', '2014-01-01 18:00:00', 'Landon Hotel'),
	...
	(7, 'Swing into Spring', 'Swing into Spring with your favorite springtime dishes! Fresh produce and delectable deserts will be featured during this vegan-friendly soiree!', '2019-04-01 12:00:00', 'The Kale Grotto'),
...
-- Exportiere Daten aus Tabelle restaurant.eventslocations: ~5 rows (ungefähr)
INSERT INTO `eventslocations` (`id`, `EventName`, `Location`) VALUES
	(1, 'Winter Wonderland', 'Landon Hotel'),
	(2, 'Eating Healthy at School', 'Teaching Kitchen'),
	(3, 'Swing into Spring', 'The Kale Grotto'),
	(4, 'Summer\'s Here', 'Rooftop Pool'),
	(5, 'Fall Ball', 'Rick\'s Organic Pumpkin Farm');

-- Exportiere Daten aus Tabelle restaurant.orders: ~10 rows (ungefähr)
INSERT INTO `orders` (`OrderID`, `CustomerID`, `OrderDate`) VALUES
	(1, 17, '2019-02-01 17:32:00'),
...
-- Exportiere Daten aus Tabelle restaurant.ordersdishes: ~20 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle restaurant.reservations: ~13 rows (ungefähr)
INSERT INTO `reservations` (`ReservationID`, `CustomerID`, `Date`, `PartySize`) VALUES
	(1, 17, '2019-02-05 14:00:00', 3),
	(2, 45, '2019-02-05 14:30:00', 4),
	(3, 51, '2019-02-06 20:00:00', 2),
	(4, 89, '2019-02-06 11:00:00', 1),
	(5, 44, '2019-02-07 13:30:00', 5),
	(6, 39, '2019-02-08 10:00:00', 4),
	(7, 86, '2019-02-08 15:15:00', 3),
	(8, 17, '2019-02-09 13:00:00', 3),
	(9, 39, '2019-02-09 10:00:00', 5),
	(10, 33, '2019-02-09 10:00:00', 4),
	(11, 78, '2019-02-06 14:30:00', 3),
	(12, 84, '2019-02-06 18:00:00', 5),
	(13, 9, '2019-02-06 15:00:00', 4);
